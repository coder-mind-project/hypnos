...
var ArticleAction = /** @class */ (function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        _b = (_a = res).json;
                        return [4 /*yield*/, this._app.ServiceLocator.articleService.getRelateds(req.params.customUri)];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [3 /*break*/, 3];
                    case 2:
    ...
    ArticleAction.prototype.getOne = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, err_4;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        _b = (_a = res).json;
                        return [4 /*yield*/, this._app.ServiceLocator.articleService.getByCustomUri(req.params.customUri)];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [3 /*break*/, 3];
                    case 2:
    ...
    ArticleAction.prototype.postComment = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, err_5;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        _b = (_a = res).json;
                        return [4 /*yield*/, this._app.ServiceLocator.commentService.saveComment(req.body, req.params.customUri)];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [3 /*break*/, 3];
                    case 2:
